...
const createIcon = (path: React.ReactNode, className="h-8 w-8") => () => (
...
export const ThumbsUpIcon = createIcon(
    <path strokeLinecap="round" strokeLinejoin="round" d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.085a2 2 0 00-1.736.97l-2.714 4.224a2 2 0 01-1.29 1.292c-.63.28-1.296.28-1.926 0A2 2 0 012 11.595V14a2 2 0 002 2h4v3H6a2 2 0 00-2 2v1a2 2 0 002 2h12a2 2 0 002-2v-4a2 2 0 00-2-2h-3.236l3.5-7A2 2 0 0018.764 5H16a2 2 0 00-2 2z" />
);
